...
public class App {
    ...
    public static void enroll (String personType) throws Exception{
        ...
        if(personType.equalsIgnoreCase("Employee")){
            File file=new File("D:\\Java\\Student Management System\\Student Management System\\src\\Employee.txt");
            try (PrintWriter pw = new PrintWriter(new FileOutputStream(file,true))) {
                String name;
                int age;
                String address;
                ...
                address=s.nextLine();
                System.out.print("Enter the employeeId of Employee: ");
                employeeId=s.nextLine();
                System.out.print("Enyter the role");
                role=s.nextLine();
                System.out.print("enter the salary: ");
                salary=s.nextDouble();
                Student student=new Student(name, age,address, employeeId, role, salary);
                pw.print(student.toString());
            }
        }

    }
    public static void getInfo(String personType){
